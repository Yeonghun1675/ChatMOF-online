...
from revised_tools.predictor.utils import _predictable_properties, model_names
from chatmof.tools.search_csv.base import TableSearcher
from revised_tools.genetic_algorithm.genetic_algorithm import GeneticAlgorithmChain
from revised_tools.genetic_algorithm.prompt import PLAN_PROMPT
from revised_tools.genetic_algorithm.cif_generate import CIFGenerator
...
class Generator(Chain):
    ...
    def _call(
        ...
        raise ChatMOFOnlineError('ChatMOF online-demo does not support generation task. If you want use more toolkits, please use code on our github.')
